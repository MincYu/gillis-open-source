...
worker_url_dict = json.loads('{"0_17_3": "http://172.31.20.179:32881", "0_17_4": "http://172.31.20.179:32880", "0_17_1": "http://172.31.20.179:32882", "0_17_2": "http://172.31.20.179:32879", "18_23_1": "http://172.31.20.179:32883", "18_23_2": "http://172.31.20.179:32884", "18_23_3": "http://172.31.20.179:32885", "18_23_4": "http://172.31.20.179:32886", "24_29_4": "http://172.31.20.179:32887", "24_29_1": "http://172.31.20.179:32889", "24_29_3": "http://172.31.20.179:32888", "24_29_2": "http://172.31.20.179:32890"}')
...
def worker(func_name, json_data):
    ...
    output_key = json_result['key']
    latency = json_result['latency']

    output = pickle.loads(r.get(output_key))
...
def do_parallel(model_dict, start_clock):
    ...
    for fid, func_dict in model_dict.items():
        if not fid == 0:
            ...
            pickled_input = pickle.dumps(func_dict['input_data'])
            r.set(func_name, pickled_input)
            json_input = {
                'clock': start_clock,
                'key': func_name
            }
            func_name_input.append((func_name, json_input))
            thread_num += 1
        else:
            master_flag = 1
